...
CREATE TABLE oboe.scanresultsonlocations (
    "scanDate" date,
    "locationName" text,
    "birdSpecies" text,
    birdtraits set<text>,
    uniquebirdid uuid,
    PRIMARY KEY (("scanDate", "locationName"), "birdSpecies")
) WITH CLUSTERING ORDER BY ("birdSpecies" ASC)
